class FoodtrucksController < ApplicationController
  ...
  def foodtruck_params
    ...
    foodtruck_hash = foodtruck_hash.merge(name: params_hash[:name])
    foodtruck_hash = foodtruck_hash.merge(cuisine: params_hash[:cuisine])
    foodtruck_hash = foodtruck_hash.merge(signature_item: params_hash[:signature_item])
    foodtruck_hash = foodtruck_hash.merge(truck_pic: params_hash[:truck_pic])
    foodtruck_hash = foodtruck_hash.merge(yelp_url: params_hash[:yelp_url])
  end
end
